# Airbnb_Dataset_Project

The 'Airbnb_Dataset_Project' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] IMDB_Project_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/Airbnb_Dataset_Project.job.yml). The schedule
